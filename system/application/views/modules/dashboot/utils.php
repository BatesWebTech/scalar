    ...
    <section class="col-xs-10" style="width:79%;">
    	...
    	<?php if ('api-explorer'==$pill): ?>
	        ...
	        if (file_exists(FCPATH.$path)) {
	        	...
	        	echo '<div class="alert alert-warning">Please contact a system administrator to install the <b>API Explorer</b> plugin at <b style="white-space:nowrap;">/system/application/plugins/apiexplorer</b>.</div>';
	        }
	        echo '</div>';
	        ?>
	    <?php endif; ?>
